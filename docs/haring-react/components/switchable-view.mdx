...
<Description
  ...
  importExample="import { SwitchableView } from '@smile/haring-react';"
  packageInfo={{
    label: '@smile/haring-react',
    link: 'https://www.npmjs.com/package/@smile/haring-react',
  }}
  sourceInfo={{
    link: 'https://github.com/Smile-SA/haring/blob/main/packages/haring-react/src/Components/SwitchableView/SwitchableView.tsx',
  }}
  storybookInfo="3-custom-components-switchableview--docs"
>
