...
<Description
  extendsInfo={[
    { label: 'Button', link: 'https://v6.mantine.dev/core/button/' },
    { label: 'Collapse', link: 'https://v6.mantine.dev/core/collapse/' },
  ]}
...
import { CollapseButton } from '@smile/react-front-kit';
